...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2016 at 05:45 PM
...
CREATE TABLE IF NOT EXISTS `elrh_gallery_galleries` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin2 COLLATE=latin2_czech_cs PACK_KEYS=0 AUTO_INCREMENT=98 ;
...
(97, 0, 'ellrohir', '2016-01-23 16:30:10', 'Test 1000', 'Testování uploadů');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin2 COLLATE=latin2_czech_cs AUTO_INCREMENT=1316 ;
...
(991, 'ellrohir', '2014-10-16 20:48:31', 1, 46, 'Domov pro seniory', 'Domov pro seniory v ulici Sulická. Postaven 1963, pohlednice odeslána v roce 1968.', '1413485311.jpg', 493, 1310),
...
(1310, 'ellrohir', '2016-01-23 16:45:11', 1, 46, 'Test uploadu', 'eee', '1453563911.jpg', 991, 1311),
(1311, 'ellrohir', '2016-01-23 16:49:08', 1, 47, 'Test uploadu', 'EEEEEE', '1453564148.jpg', 1310, 1312),
(1312, 'ellrohir', '2016-01-23 16:50:49', 1, 48, 'Upload 1', '', '1453564248.png', 1311, 0),
(1313, 'ellrohir', '2016-01-23 16:51:34', 97, 1, 'Upload 1', 'EEE', '1453564294.png', 0, 1314),
(1314, 'ellrohir', '2016-01-23 16:53:07', 97, 2, 'Upload 2', 'EEEE', '1453564387.png', 1313, 1315),
(1315, 'ellrohir', '2016-01-23 16:54:58', 97, 3, 'Upload 3', 'EFWES', '1453564498.png', 1314, 0);
...
('ga_id', 'Site-ID for Google Analytics', 'NONE'),
...
CREATE TABLE IF NOT EXISTS `elrh_texts` (
  ...
  `value` text COLLATE utf8_czech_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci AUTO_INCREMENT=176 ;
...
('ellrohir', 'Password not shown - public repository', 'seckar@svobodni.cz', 'http://alois-seckar.cz', 'Alois Sečkár'),
('rakcesa', 'Password not shown - public repository', 'rakcesa@seznam.cz', 'http://krc-historie.cz', 'Anton Sečkár');
